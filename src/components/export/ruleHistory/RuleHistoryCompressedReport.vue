...
import RuleHistoryCompressedCoverReport from './RuleHistoryCompressedCoverReport.vue';
import RuleHistoryCompressedReportTable from './RuleHistoryCompressedReportTable.vue';
...
<template>
  <div id="container_content_rule_compressed" class="style-hidden-content">
    <BaseReportCompressed 
      ...
      <template #content>
        <div>
          <RuleHistoryCompressedCoverReport 
    ...
    <div v-for="(item, index) in groupsData">
        ...
        <template #content>
            <div>
            <RuleHistoryCompressedReportTable
                :items="item"
            />
            </div>
        </template>
